 ...
 */
public class waterCoreProcessor {
    ...
    public waterCoreProcessor(String rootDirPath) throws Exception{
    ...
    public String sentenceReduction(String queryPattern) {
        ...
        for (String key : set) {
            /**如果句子模板中含有抽象的词性*/
            if(queryPattern.contains("hyst")){
                String value = abstractMap.get("nm");
                queryPattern = queryPattern.replace("hyst", value);
            }
            if(queryPattern.contains("dam")){
                String value = abstractMap.get("nm");
                queryPattern = queryPattern.replace("dam", value);
            }
            if(queryPattern.contains("rv")){
                String value = abstractMap.get("nm");
                queryPattern = queryPattern.replace("rv", value);
            }
