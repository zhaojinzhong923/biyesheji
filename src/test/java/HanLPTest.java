...
//        customDict(lineStr,"虽然会","ng 0");
        String lineStr = "卧虎藏龙的评分是多少？";
        customDict(lineStr,"卧虎藏龙","ng 0");
    }
    ...
    public void TestC() throws Exception{
        waterCoreProcessor query = new waterCoreProcessor("D:/HanLP/data");
        String[] questionArr = new String[] {"卧虎藏龙的分数是多少"};
//        String[] questionArr = new String[] {"易水二干北排干的流经区域"};
